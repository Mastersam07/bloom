import 'package:bloom/core/viewmodels/login_model.dart';
import 'package:bloom/core/views/view_builder.dart';
import 'package:bloom/core/views/view_state_builder.dart';
import 'package:bloom/locator.dart';
...
class SignIn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BaseViewBuilder<LoginModel>(
          model: locator(),
